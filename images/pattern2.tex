...
\node (n41) [circle, draw, inner sep=0pt, minimum size=0.75ex] {}; & \node (n42) [nonterminal] {Funktion}; & \node (n43) [point] {}; & \node (n44) [point] {}; & \node (n45) [terminal] {(}; & \node (n46) [nonterminal] {Konstruktor}; & \node (n47) [point] {}; & \node (n48) [nonterminal] {erwarteter Wert}; & \node (n49) [point] {}; & \node (n410) [terminal] {)}; & \node (n411) [point] {}; & \node (n412) [point] {}; & \node (n413) [terminal] {=}; & \node (n414) [nonterminal] {Ausdruck}; & \node (n415) [circle, draw, inner sep=0pt, minimum size=0.75ex] {};\\
  ...
  { [start chain]
       \chainin (n411);
       \chainin (n27)    [join=by vh path];
       \chainin (n44)    [join=by {hv path,tip}];
  }
  { [start chain]
       \chainin (n412);
       \chainin (n17)    [join=by vh path];
